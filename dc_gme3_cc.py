...
def dc_gme3_cc(Dtilde, C, rho, gamma, u0, vec_x, p):
    """
    Difference of convex algorithm (DCA) for convex clustering with generalized Moreau envelope (3rd model).
...
# gamma = 0.1
# u0 = np.array([0.5, 1.5])
# vec_x = np.array([1, 2, 3, 4, 5, 6])
# p = 2

# v_opt, z_opt, u_opt, cput = dc_gme3_cc(Dtilde, C, rho, gamma, u0, vec_x, p)
